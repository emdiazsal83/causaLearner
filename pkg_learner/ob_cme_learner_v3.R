...
for(i in 1:nrow(kernelTab1)){
  ...
  optimizeParams_bin <- list(losses=list(negCE=negCE, MisCR=MisCR, cmem_L2_f=cmem_L2_f, cmem_L2_k=cmem_L2_k, KCDC=KCDC, KCMC=KCMC, KCRDC=KCRDC), numFolds=5, testTrain="test")
  optimizeParams_other <- list(losses=list(negCE=negCE, MisCR=MisCR, cmem_L2_f=cmem_L2_f, cmem_L2_k=cmem_L2_k, KCDC=KCDC, KCMC=KCMC, KCRDC=KCRDC, KCSC=KCSC, KCNSC=KCNSC, KCCC_ent=KCCC_ent), numFolds=5, testTrain="test")
  ...
  measureParamsFull <- list(KCDC=list(func="KCDC", aggFunc="sum",pars=list()),
  ...
  measureParamsRed  <- list(KCDC=list(func="KCDC", aggFunc="sum",pars=list()),
                            KCRDC = list(func="KCRDC", aggFunc="sum", pars=list()),
                            KCMC=list(func="KCMC", aggFunc="sum",pars=list()))
