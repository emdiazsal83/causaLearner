...
source("./hypothesisScorers/pkg_ANM_hypothesisScorer/func_learners_v2.R")
...
optimizeParams <- list(losses=list(hsicLoss=hsicLoss, sse=sse, rmse=rmse, corre=corre), numFolds=5, max_iterations1=10, max_iterations2=1000, num_init=2)
heuristicSet <- getFixedParams
optimizeSet <- optHP.CV
