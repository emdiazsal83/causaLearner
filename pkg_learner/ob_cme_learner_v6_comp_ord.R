...
print("enters ob_cme_learner_v6_ord.R")
...
NCE_classifiers <- c("vanilla") #"logRegInt1", "logRegInt2","logRegInt2", "cmeClass1"
...
for(i in 1:nrow(kernelTab1)){
  ...
  losses <- list(RMSE2=list(func="RMSE2"),gauss_log_lik=list(func="gauss_log_lik"), cmem_L2_f_rel=list(func="cmem_L2_f_rel"),
...
ppTab <- data.frame(id=c("KCDC","WKCDC","KCDCrel","KCDCpval2","KCRDC","KCMC","WKCMC", "KIIM","KCMCpval","KCSC","KICSC", "KCSCpval","KCCC", "KICCC","KCCCpval", "KCNSC",
                         "MCX","EDML","EDMB","TRE","gll_tr","gll_te","L2_f_tr","L2_f_te","wL2_f_te","L2_k_te","wL2_k_te","RMSEte","corrRKHS_k_te","wcorrRKHS_k_te","PCEtr","PCEte","CCRtr","CCRte","CVTeRNE", "CVTrRNE", "EAL", "DAL", "rankMajority","majority","HSIC"))
...
print("exits ob_cme_learner_v6.R")
