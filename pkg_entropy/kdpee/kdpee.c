...
//  interested in
double kdpee_recurse(const double **dimrefs, const int n, const int d, double *mins, 
                       double *maxs, const double zcut, int *keys,
                       bool mayTerminate, int curlev, const double n_rec,
                       int minindex, int maxindex, int minlev
);
double kdpee_hoareMedian(const double *oneRow, int *keys, int minindex, int maxindex);
double kdpee_hoareFind(const double *oneRow, int *keys, int minindex, int maxindex, int findThis);
void   kdpee_hoarePartition(const double *oneRow, int *keys, int minindex, int maxindex, 
