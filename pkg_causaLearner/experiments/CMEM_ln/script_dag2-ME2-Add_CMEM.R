...
# pm <- proc.time()
# set.seed(5)
# dataList <- simRandSEMs(q, ps, ns, nodess, sigma=1, markovEquiv=T, dagMat=dagMat)
...
# 35.4 secs for kernParsX_1 with 1-6 cores on my pc with 1-1 in CV
# 41.78 secs for kernParsX_1 with 2-3 cores on my pc with 1-1 in CV
# 112 secs for kernParsX_1 with 1-1 cores on my pc with 1-1 in CV
# 52.4 secs for kernParsX_1 with 1-1 cores on my pc with 5-1 in CV
# 163 secs for kernParsX_1 with 1-1 cores on my pc with 1-5 in CV
# 112 secs for kernParsX_1 with 1-1 cores on my pc with 2-2 in CV
# seems like its best to parallelize on applyLearnRecipes level and on parameters but not on folds

#  26 mins for kernParsX_1 with 1-1 cores on ERC with 2-2 in CV
#  14.2 mins for kernParsX_1 with 2-9 cores on ERC with 3-1 in CV
#  16 mins for kernParsX_1 with 2-9 cores on ERC with 1-1 in CV
#  25 mins for kernParsX_1 with 1-1 cores on ERC with 5-1 in CV
#  21 mins for kernParsX_1 with 1-1 cores on ERC with 10-1 in CV
#  15 mins for kernParsX_1 with 1-1 cores on ERC with 20-1 in CV
#  13.6 mins for kernParsX_1 with 1-1 cores on ERC with 30-1 in CV
# 13 mins for kernParsX_1 with 1-1 cores on ERC with 56-1 in CV
...
# scores <- lapply(blockFiles[indx], function(el){
...
# 8.6 mins for none_1      with 1-1-6 cores on my pc with 1-1 in CV and 100 perms for pvalues
# 1.86 hours for none_1      with 1-1-6 cores on my pc with 1-1 in CV and 1000 perms for pvalues

# for kernParsX_1 with 1-1-6 cores on my pc with 1-1 in CV

save("scores", file=paste("./pkg_causaLearner/experiments/CMEM/results/", experimentName, ".RData", sep=""))
