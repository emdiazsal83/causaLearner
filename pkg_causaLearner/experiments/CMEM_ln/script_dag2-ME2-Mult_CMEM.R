...
experimentName <- "dag2-ME2-Mult_cmem-none"
...
# pm <- proc.time()
# set.seed(5)
# dataList <- simRandSEMs(q, ps, ns, nodess, sigma=1, markovEquiv=T, dagMat=dagMat, geU=function(y, nois, scale, constant) y*nois)
