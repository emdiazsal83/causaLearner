...
experimentName <- "dag5-ME32-Cmplx_cmem-none-CV"
dataName <- strsplit(experimentName, "_")[[1]][1]
hs_cmem_ob_version <- "CV_v4_cc"
...
hypScorerList <- c(cmem_hypScorer_pack_none_1) 
...
save(list=ls(), file=paste("./pkg_causaLearner/experiments/CMEM/results/", experimentName,"_",hs_cmem_ob_version,".RData", sep=""))
...
dim(scores[[1]][["norm"]][["oracleME1"]][["hs_cmem_kern_quadANDkern_laplace1_cn_L2_none_1_1_1"]])
scores[[2]][["norm"]][["oracleME1"]][["hs_cmem_kern_quadANDkern_laplace1_cn_L2_none_1_1_1"]]

rownames(scores[[1]][["norm"]][["oracleME1"]][["hs_cmem_kern_quadANDkern_laplace1_cn_L2_none_1_1_1"]]) %in% dagIds$id

i <- 5
dagIds$id[i]
scores[[i]][["norm"]][["oracleME1"]][["hs_cmem_kern_quadANDkern_laplace1_cn_L2_none_1_1_1"]]
aggScores[[i]][["norm"]][["oracleME1"]][["hs_cmem_kern_quadANDkern_laplace1_cn_L2_none_1_1_1"]]
rnkDecs[[i]][["norm"]][["oracleME1"]][["hs_cmem_kern_quadANDkern_laplace1_cn_L2_none_1_1_1"]]
...
indx <- which(scoreDB$score=="KCMC" & scoreDB$hypSc=="hs_cmem_kern_quadANDkern_laplace1_cn_L2_none_1_1_1")
length(indx)

cast(scoreDB[indx,], dataset~ hypothesis, fun.aggregate="length")
scrsKCMC <- cast(scoreDB[indx,], dataset~ hypothesis, value="value")
scrsKCMC <- scrsKCMC[order(as.numeric(scrsKCMC$dataset)),]

rnkDecsArr <- scoreDBToArray(scoreDB, names_datasets=dataList$names, value="value")

rnkDecsArr[,,"norm.oracleME1.hs_cmem_kern_quadANDkern_laplace1_cn_L2_none_1_1_1.KCMC.agg_truevsRest"]
...
cast(statsDB[indx,], hypSc+lambda+degree~cmplxFunc, value="value", fun.aggregate="length")
tab <- cast(statsDB[indx,], degree+lambda~cmplxFunc, value="value")
