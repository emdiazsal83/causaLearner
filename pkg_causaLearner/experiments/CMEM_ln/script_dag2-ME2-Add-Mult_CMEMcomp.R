...
experimentName <- "dag2-ME2-Add-Mult_cmem-comp-4-l2"
...
# names(dataList1); names(dataList2)
# dataList1$names; dataList2$names
# dataListList <- list(Add=dataList1, Mult=dataList2)
